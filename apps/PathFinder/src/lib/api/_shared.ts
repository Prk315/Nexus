...
//
// api.ts was a single 3,142-line file that every feature had to edit, which is
...
import type {
  Goal, Plan, Task, TaskWithContext, SystemEntry, Deadline, ScheduleEntry, CalBlock, CourseAssignment, PipelineStep, RoadmapItem, CourseBook, BookSection, BookReadingLog, TaskPlanning, TaskSession, TaskType,
} from "../../types";
